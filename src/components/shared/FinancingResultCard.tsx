  ...
  return (
    <div className="bg-red-50 rounded-lg p-5 border border-red-200 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-3 border-t border-red-200">
        <div className="bg-white rounded-lg p-2 border border-gray-200 order-2 md:order-1">
        ...
        <div className="bg-white rounded-lg p-2 border border-gray-200 order-3 md:order-2">
        ...
        <div className="bg-white rounded-lg p-2 border-2 border-red-400 shadow-sm order-1 md:order-3">
