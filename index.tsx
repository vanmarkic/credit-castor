...
export default function EnDivisionCorrect() {
  ...
  const exportToExcel = () => {
    ...
    const headerRow = ['Nom', 'Unite', 'Quantite', 'Surface/unite', 'Surface totale', 'Capital', 'Taux notaire', 'Taux interet', 'Duree (ans)', 'Part achat', 'Frais notaire', 'CASCO', 'Parachevements', 'Travaux communs', 'Construction', 'Quote-part', 'TOTAL', 'Emprunt', 'Mensualite', 'Total rembourse'];
    ...
    calculations.participantBreakdown.forEach((p, idx) => {
      ...
      ws['J' + r] = { t: 'n', f: 'E' + r + '*$B$9' };
      ws['K' + r] = { t: 'n', f: 'J' + r + '*G' + r + '/100' };
      ws['N' + r] = { t: 'n', f: '$B$33' };
      ws['O' + r] = { t: 'n', f: '((L' + r + '+M' + r + ')*(1+$B$12/100)+N' + r + ')*C' + r };
      ws['P' + r] = { t: 'n', f: '$B$26' };
      ws['Q' + r] = { t: 'n', f: 'J' + r + '+K' + r + '+O' + r + '+P' + r };
      ws['R' + r] = { t: 'n', f: 'Q' + r + '-F' + r };
      ws['S' + r] = { t: 'n', f: 'PMT(H' + r + '/100/12,I' + r + '*12,R' + r + ')*-1' };
      ws['T' + r] = { t: 'n', f: 'S' + r + '*I' + r + '*12' };
    });
    ...
    ws['E' + totalRow] = { t: 'n', f: 'SUM(E' + startRow + ':E' + endRow + ')' };
    ws['F' + totalRow] = { t: 'n', f: 'SUM(F' + startRow + ':F' + endRow + ')' };
    ...
    ws['Q' + totalRow] = { t: 'n', f: 'SUM(Q' + startRow + ':Q' + endRow + ')' };
    ws['R' + totalRow] = { t: 'n', f: 'SUM(R' + startRow + ':R' + endRow + ')' };
    ws['T' + totalRow] = { t: 'n', f: 'SUM(T' + startRow + ':T' + endRow + ')' };
    ...
    ws['B' + (synthRow + 2)] = { t: 'n', f: 'Q' + totalRow };
    ws['B' + (synthRow + 3)] = { t: 'n', f: 'F' + totalRow };
    ws['B' + (synthRow + 4)] = { t: 'n', f: 'R' + totalRow };
    ws['B' + (synthRow + 5)] = { t: 'n', f: 'AVERAGE(R' + startRow + ':R' + endRow + ')' };
    ws['B' + (synthRow + 6)] = { t: 'n', f: 'MIN(R' + startRow + ':R' + endRow + ')' };
    ws['B' + (synthRow + 7)] = { t: 'n', f: 'MAX(R' + startRow + ':R' + endRow + ')' };
    
    // Définir la largeur des colonnes
    ws['!cols'] = [
      {wch: 25}, {wch: 8}, {wch: 10}, {wch: 14}, {wch: 14},
      {wch: 15}, {wch: 14}, {wch: 12}, {wch: 12}, {wch: 15},
